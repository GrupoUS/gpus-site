...
Reference full template: `/home/mauricio/gpus/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/mauricio/gpus/.claude/get-shit-done/templates/state.md`.
