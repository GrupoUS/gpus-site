...
if [ -n "$SUBAGENT" ]; then
  case "$SUBAGENT" in
    ...
    gsd-user-profiler|gsd-executor|gsd-integration-checker|gsd-ui-checker|gsd-verifier|gsd-planner|gsd-phase-researcher|gsd-plan-checker|gsd-advisor-researcher|gsd-assumptions-analyzer|gsd-codebase-mapper|gsd-ui-auditor|gsd-nyquist-auditor|gsd-debugger|gsd-project-researcher|gsd-research-synthesizer|gsd-roadmapper|gsd-ui-researcher)
      ;;
    *)
