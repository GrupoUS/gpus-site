...
| `/perf [build]` | Performance issue (default = runtime Lighthouse / PSI). `db` mode not applicable here (no DB). |
...
| **Project** (brand SSOT) | `gpus-theme`, `grupo-us` |
