...
# Stability — Grupo US · Site Institucional (Tier 2 — project authority)

> Quality bar + smoke tests + anti-patterns + debug triage for a static Astro site.
...
| Need | Load |
|---|---|
| Page / component patterns / Content Collections / WhatsApp SSOT / a11y | `.claude/rules/frontend.md` |
