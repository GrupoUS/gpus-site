...
- **Global scope**: `/home/mauricio/gpus/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/mauricio/gpus/.cursor/notes/`)
...
2. Glob `/home/mauricio/gpus/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/mauricio/gpus/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/mauricio/gpus/.cursor/notes/` — works in any directory
